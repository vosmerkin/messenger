            ...
            public void actionPerformed(ActionEvent e) {
                new SwingWorker() {
                    ...
                    protected Object doInBackground() throws Exception {
                        UserDto result;
                        if ("User Login".equals(userLoginButton.getText())) {
                            result = backendClient.userRequestAction(userNameTextField.getText());
                            if (!(result == null)) {
                                if (!(result.getContactList() == null)) {
                        ...
                        } else if ("User Logoff".equals(userLoginButton.getText())) {
                            result = backendClient.userUpdateStatusAction(userNameTextField.getText());
                            if (!(result == null)) {
